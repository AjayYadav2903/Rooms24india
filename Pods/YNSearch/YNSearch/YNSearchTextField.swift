...
open class YNSearchTextField: UITextField,UITextFieldDelegate {
    ...
    open func initView() {
        ...
        self.placeholder = "Search for Hotel,City or Location"
...
open class YNSearchTextFieldView: UIView,UITextFieldDelegate {
